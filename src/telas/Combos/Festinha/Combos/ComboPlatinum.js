...
export default function ComboPlatinum() {
  const comboPlatinum = combosFestinhas.comboPlatinum;
  ...
  const inseriComboPlatinum = {
    combo: "Combo Platinum Festas",
    valor: 220
  }

  async function insereSacolaComboPlatinum() {
            ...
            <div className="combo-divisao">
              <div className="container-comida">
                <h4 className="container-titulo">
                  ...
                  <h5 className="container-titulo-unidade">(250 unid)</h5>
                </h4>

                <div className="container-linha">
                  <h5>
                    {comboPlatinum.detalhado.containerComida.itens[0]} (25unid)
                  </h5>
                ...
                <div className="container-linha">
                  <h5>
                    {comboPlatinum.detalhado.containerComida.itens[1]} (25unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboPlatinum.detalhado.containerComida.itens[2]} (25unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboPlatinum.detalhado.containerComida.itens[3]} (25unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-comida">
                  <h4 className="container-titulo">
                    ...
                    <h5 className="container-titulo-unidade">
                      (8 Refrigerantes 2L ou 8 Suco 1L)
                    </h5>
                  </h4>
            ...
            <div className="container-pagamento">
              <div className="pagamento-texto">
                <h4 className="pagamento-titulo">
                  Total:
                  <h4 className="pagamento-subtitulo">
                    R${comboPlatinum.valor}
                  </h4>
                </h4>
              </div>
              <button
