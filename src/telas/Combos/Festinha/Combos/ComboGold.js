...
export default function ComboGold() {
  const comboGold = combosFestinhas.comboGold;
  ...
  const [sacolaComboGold, setSacolaComboGold] = useState("Combo Gold");
  const [sacolaComboGoldValor, setSacolaComboGoldValor] = useState(140);
  const [sacolaPedido, setSacolaPedido] = useState([]);

  const inseriComboGold = {
    combo: "Combo Gold Festas",
    valor: 140
  }
            ...
            <div className="combo-divisao">
              <div className="container-comida">
                <h4 className="container-titulo">
                  ...
                  <h5 className="container-titulo-unidade">(150 unid)</h5>
                </h4>

                <div className="container-linha">
                  <h5>
                    {comboGold.detalhado.containerComida.itens[0]} (25unid)
                  </h5>
                ...
                <div className="container-linha">
                  <h5>
                    {comboGold.detalhado.containerComida.itens[1]} (25unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboGold.detalhado.containerComida.itens[2]} (25unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboGold.detalhado.containerComida.itens[3]} (25unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-comida">
                  <h4 className="container-titulo">
                    ...
                    <h5 className="container-titulo-unidade">
                      (4 Refrigerantes 2L ou 4 Suco 1L)
                    </h5>
                  </h4>
