...
export default function ComboMaster() {
  const comboMaster = combosPizzas.comboMaster;
            ...
            <div className="combo-divisao">
              <div className="container-comida">
                <h4 className="container-titulo">
                  ...
                  <h5 className="container-titulo-unidade">(2 Pizzas Gigantes)</h5>
                </h4>

                <div className="container-linha">
                  <h5>
                    {comboMaster.detalhado.containerComida.itens[0]} 
                  </h5>
                ...
                <div className="container-linha">
                  <h5>
                    {comboMaster.detalhado.containerComida.itens[1]} 
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboMaster.detalhado.containerComida.itens[2]} 
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboMaster.detalhado.containerComida.itens[3]} 
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
