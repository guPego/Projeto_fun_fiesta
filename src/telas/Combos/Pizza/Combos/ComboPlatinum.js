...
export default function ComboPlatinum() {
  const comboPlatinum = combosPizzas.comboPlatinum;
            ...
            <div className="combo-divisao">
              <div className="container-comida">
                <h4 className="container-titulo">
                  ...
                  <h5 className="container-titulo-unidade">(2 Pizzas)</h5>
                </h4>

                <div className="container-linha">
                  <h5>
                    {comboPlatinum.detalhado.containerComida.itens[0]}
                  </h5>
                ...
                <div className="container-linha">
                  <h5>
                    {comboPlatinum.detalhado.containerComida.itens[1]}
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboPlatinum.detalhado.containerComida.itens[2]}
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboPlatinum.detalhado.containerComida.itens[3]}
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-comida">
                  <h4 className="container-titulo">
                    ...
                    <h5 className="container-titulo-unidade">
                      (2 Refrigerantes 2L ou 2 Suco 1L)
                    </h5>
                  </h4>
