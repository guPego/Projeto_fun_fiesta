...
export default function ComboMaster() {
  const comboMaster = combosHamburguer.comboMaster;
            ...
            <div className="combo-divisao">
              <div className="container-comida">
                <h4 className="container-titulo">
                  ...
                  <h5 className="container-titulo-unidade">(10 Hamburgueres)</h5>
                </h4>

                <div className="container-linha">
                  <h5>
                    {comboMaster.detalhado.containerComida.itens[0]} (1 unid)
                  </h5>
                ...
                <div className="container-linha">
                  <h5>
                    {comboMaster.detalhado.containerComida.itens[1]} (1 unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboMaster.detalhado.containerComida.itens[2]} (1 unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-linha">
                  <h5>
                    {comboMaster.detalhado.containerComida.itens[3]} (1 unid)
                  </h5>
                  <div className="linha-quantidade">
                    <BsChevronDoubleLeft
                      style={{}}
                ...
                <div className="container-comida">
                  <h4 className="container-titulo">
                    ...
                    <h5 className="container-titulo-unidade">
                      (3 Refrigerantes 2L ou 3 Suco 1L)
                    </h5>
                  </h4>
            ...
            <div className="container-pagamento">
              <div className="pagamento-texto">
                <h4 className="pagamento-titulo">
                  Total:<h4 className="pagamento-subtitulo">R${comboMaster.valor}</h4>
                </h4>
              </div>
